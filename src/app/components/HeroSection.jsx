    ...
    <section>
        <div className="grid grid-cols-1 lg:grid-cols-12">
          <div className='col-span-7 place-self-center'>
            <h1 className="text-white mb-4 text-4xl lg:text-6xl font-extrabold">Hey there, Im Josue!</h1>
            <p className='text-[#ADB7BE] text-lg mb-6 lg:text-xl'>
                This is an example paragraph that will be replaced later with useful information.
            </p>
            <div>
